...
namespace ReceptionOfPatients
{
    public class Program
    {
        ...
        private static void AddData(AppContext appContext)
        {
        ...
        private static void ReadData(AppContext appContext)
        {
        }
        private static void RemoveData(AppContext appContext)
        {
